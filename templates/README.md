...
| テスト | [Test Plan](documentation/test-plan.md) | テストの目的、範囲、リスク、設計方針、日程、判定基準、環境とデータの要件、体制を定め、テスト設計、実装、実行の指針にするテンプレート。 | ISO/IEC/IEEE 29119に準拠する。 |
| テスト | [Test Design Specification](documentation/test-design-specification.md) | テスト対象と観点を細分化し、テストマップ、機能動作確認一覧、テスト明細を経てテストケースへ落とし込むテンプレート。 | ISO/IEC/IEEE 29119に準拠する。 |
| テスト | [Test Case Specification](documentation/test-case-specification.md) | 実行前に、テスト対象、観点、実行条件、実行手順、期待結果、参照を定めるテンプレート。 | ISO/IEC/IEEE 29119に準拠する。 |
