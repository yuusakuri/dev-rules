...
7. [実行結果の記録](#7-実行結果の記録)
8. [規格への準拠が求められる場合](#8-規格への準拠が求められる場合)
9. [参考資料](#9-参考資料)
...
本書は、テスト計画書、テスト設計仕様書、テストケース仕様書を作成する方法と、各文書とISO/IEC/IEEE 29119-3:2021が定めるテスト文書との対応を定める。
...
テスト文書の種類と記載する内容は、ISO/IEC/IEEE 29119-3:2021を参考にする。同規格は、テストプロセスが作成するテスト文書の種類と、各文書に書く情報項目を定める。
...
契約や組織の標準がISO/IEC/IEEE 29119-3への準拠を求める場合は、[規格準拠文書ガイドライン](standard-conformance-guidelines.md)に従い、4章から6章の対応表で「なし」または「一部」とした情報項目をテンプレートに追加する。テスト手順仕様書、テストデータ要求、テスト環境要求、準備状況報告書、テスト状況報告書、テスト完了報告書、インシデント報告書も、規格の情報項目に沿って作成する。
...
| 本書の章 | 参考資料 | 説明 |
| --- | --- | --- |
| 2. 参考にする規格<br>3. テスト文書の種類<br>4. テスト計画書<br>5. テスト設計仕様書<br>6. テストケース仕様書<br>7. 実行結果の記録<br>8. 規格への準拠が求められる場合 | [ISO/IEC/IEEE 29119-3:2021 - Software and systems engineering — Software testing — Part 3: Test documentation](https://www.iso.org/standard/79429.html) | テスト文書の種類、各文書の情報項目と要否（付属書A）、テストモデルへの置き換え、IEEE 829-2008との対応を定める。 |
| 2. 参考にする規格<br>3. テスト文書の種類 | [ISO/IEC/IEEE 29119-2:2021 - Software and systems engineering — Software testing — Part 2: Test processes](https://www.iso.org/standard/79428.html) | テストプロセスと、テストモデル、テストカバレッジ項目、テストケース、テスト手順の定義を定める。 |
| 2. 参考にする規格<br>4. テスト計画書<br>5. テスト設計仕様書 | [ISO/IEC/IEEE 29119-4:2021 - Software and systems engineering — Software testing — Part 4: Test techniques](https://www.iso.org/standard/79430.html) | テストモデルの作成、テストカバレッジ項目の特定、テストケースの導出に使うテスト設計技法を定める。 |
