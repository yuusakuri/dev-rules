...
| 実装 | [通信プロトコル実装ガイドライン](implementation/communication-protocol-guidelines.md) | 新しい通信プロトコルのフレーム形式、符号化、送受信処理、状態遷移及び性能を設計・検証するためのガイドライン。 | ソフトウェア設計ガイドライン。アプリケーションの一部として実装する場合はアプリケーション設計ガイドライン、該当する実装ガイドラインも読む |
