...
| 仕様書 | [仕様書共通規則](specifications/common.md) | 領域を問わず仕様書（API、UI、通信プロトコル、ハードウェアインターフェース、要求、安全要求など）を新規作成または変更する。専用規則がない領域ではこの規則だけを適用する。 | なし |
...
| 専用規則がない領域の仕様書を作成（通信プロトコル、ハードウェアインターフェース、要求、安全要求など） | 仕様書共通規則 |
